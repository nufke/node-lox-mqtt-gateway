...
Adaptor.prototype.publish_mqtt_structure = function() {
    ...
    Object.keys(categories).forEach( key => {
        ...
        this.mqtt_structure.categories[mqtt_uuid] =
        {
            ...
            uuid: category.uuid,
            mqtt: {
                subscribe_topic: this.mqtt_prefix_app + '/' + mqtt_uuid,
                command_topic: this.mqtt_prefix_lox + '/' + mqtt_uuid + '/cmd',
                qos: 1,
                retain: false
            },
            name: category.name,
                ...
                subcontrols[sub_uuid] =
                    {
                        ...
                        uuid: sub_uuid,
                        mqtt: {
                            subscribe_topic: this.mqtt_prefix_app + '/' + sub_uuid,
                            command_topic: this.mqtt_prefix_lox + '/' + sub_uuid + '/cmd',
                            qos: 1,
                            retain: false
                        },
